...
추상메서드를 포하맣고 있으므로 하위에서 상속받게되면 반드시 추상메서드를
오버라이딩 해야한다.*/
...
DTO(Data Transfer Object) : 데이터를 저장하고 전송하기 위한 용도의
	객체를 의미한다. VO(value Object)로 표현하기도 한다. 프로그램에
...
public class E02AbstractToInterface1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(storage.searchPersonalInfo("001024-10903333"));
	}
}
