...
class Car {
	...
	void initialize(String model, String name, int age, int energy) {
		carModel = model;
		/*
		자도창 소유주를 표현한 Human타입의 멤버변수는 아직 인스턴스를
	...
	public static void main(String[] args) {
		...
		//자동차2 객체 생성 : 
			/*
			 ...
			 직접 접근하여 인스턴스를 초기화한다, 이 경우 인스털스를
		...
		car3.showCarInfo();
		//initialize>카의 메서드호출  showCarInfo> 카의 클래스 메서드호출
		//자동차4 객체 생성
		/*
